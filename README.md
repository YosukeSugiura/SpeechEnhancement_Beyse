...
音声強調においてこれは，原信号があらゆる値を一様に取りうることを意味する．
...
誤差信号 e = s - G( x ) が正規分布に従うと仮定した場合，尤度は以下の式のようにおくことができる．
...
さて，先程の尤度は音声強調モデル G が適切に設定されている必要がある．
例えば G をニューラルネットワークなどでモデリングする場合，以下の式を元に学習する．
